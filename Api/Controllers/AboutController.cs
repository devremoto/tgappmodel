...
namespace Api.Controllers
{
    ...
    {
        public AboutController(IAboutAppService service, IWebHostEnvironment hostingEnvironment, AppModelConfiguration configuration, IMapper mapper, INotificationHub notification)
